    ...
    >
      ...
      >
        ...
        <div className="max-w-4xl text-black mx-auto p-6 pt-8 w-[80%] sm:w-[80%] md:w-[60rem] h-screen md:h-auto relative">
          ...
          <div className="top-5/8 transform -translate-y-1/2 w-full flex flex-col md:flex-row justify-between gap-4 mt-4 mb-8 px-4">
            {/* Card 1 */}
            ...
            <div className="relative bg-gray-100 p-6 rounded-lg shadow-md w-full md:w-3/4 overflow-hidden">
