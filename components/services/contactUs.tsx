      ...
      >
        ...
        <div className="max-w-4xl text-black mx-auto p-6 pt-8 relative">
          ...
          <div className="relative mb-4">
            ...
            <h1 className="absolute inset-0 flex items-center text-white text-3xl md:text-5xl font-bold left-[5%]">
              Get in touch
            </h1>
            <p className="absolute inset-0 flex items-center text-white text-base md:text-lg font-bold left-[5%] top-[110px]">
